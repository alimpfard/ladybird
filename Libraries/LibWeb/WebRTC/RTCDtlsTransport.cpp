...
RTCDtlsTransport::RTCDtlsTransport(JS::Realm& realm) : DOM::EventTarget(realm) { }
RTCDtlsTransport::~RTCDtlsTransport() = default;
void RTCDtlsTransport::initialize(JS::Realm& realm) { WEB_SET_PROTOTYPE_FOR_INTERFACE(RTCDtlsTransport); Base::initialize(realm); }
