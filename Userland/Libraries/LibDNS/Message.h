...
struct SOA {
    ...
    ErrorOr<String> to_string() const { return "SOA"_string; }
};
struct MX {
    u16 preference;
    DomainName exchange;
...
struct DNSKEY {
    ...
    ErrorOr<String> to_string() const { return "DNSKEY"_string; }
};
...
struct SIG {
    ...
    ErrorOr<String> to_string() const { return "SIG"_string; }
};
